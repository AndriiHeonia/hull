var assert = require("assert"),
    hull = require('../dist/hull');

describe('hull', function() {
    it('should return only top hull (without dot) of the "?" symbol', function() {
        ...
        var expected = [74, 72, 71, 62, 60, 59, 50, 49, 47, 79, 42, 81, 32, 31, 27, 1, 24, 0, 23, 22, 28, 34, 35, 43, 54, 55, 66, 67, 76, 75];
    ...
    it('should return only outer hull of the polygon with hole', function() {
        ...
        var expected = [0, 1, 13, 12, 11, 10, 8, 7, 6];
        assert.deepEqual(hull(vertices, 50), expected);
    });
});